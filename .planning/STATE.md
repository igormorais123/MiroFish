...
- **Validacao:** `python -m pytest backend\tests` com 73 testes aprovados; `npm run build` aprovado; `git diff --check` sem erro de whitespace.
...
2. Implementar auditoria numerica para percentuais, probabilidades e contagens.
3. Criar preset de baixa atividade que gere diagnostico tecnico sem fingir opiniao publica.
...
- v1.3: gate estrutural, governanca cliente/demo, auditoria de evidencias, diversidade social, cadeia de custodia e pulso OASIS.
